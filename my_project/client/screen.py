...
def first_screen():
    ...
    green = (255, 255, 255) # the color of the project name and the subheading
    font = pygame.font.SysFont('Corbel', 60) # the font of the project name
    text = font.render('Image Design', True, green) # the project name
    ...
    text = font.render('By Machine Learning', True, color, green) # the subheading
    textRect = text.get_rect()
